...
def generate_default_config(user_id):
    ...
    from app.extensions import db
    default_connfigs = [
        {'argument_key': 'server_ip', 'argument_description': '会议业务后台ip', 'type': 'string', 'pre_argument': '',
         "user_id": user_id},
        {'argument_key': 'sdk_id', 'argument_description': 'sdk_id', 'type': 'string', 'pre_argument': '',
         "user_id": user_id},
        {'argument_key': 'network_type', 'argument_description': '网络类型', 'type': 'string', 'pre_argument': '',
         "user_id": user_id},
        {'argument_key': 'manufacture', 'argument_description': '设备厂商', 'type': 'string', 'pre_argument': '',
         "user_id": user_id},
        {'argument_key': 'language', 'argument_description': '当前语言', 'type': 'string', 'pre_argument': '',
         "user_id": user_id},
        {'argument_key': 'is_overseas', 'argument_description': '是否为海外版', 'type': 'string', 'pre_argument': '',
         "user_id": user_id},
        {'argument_key': 'imei', 'argument_description': 'imei', 'type': 'string', 'pre_argument': '',
         "user_id": user_id},
        {'argument_key': 'idfa', 'argument_description': 'idfa', 'type': 'string', 'pre_argument': '',
         "user_id": user_id},
        {'argument_key': 'env_id', 'argument_description': 'env_id', 'type': 'string', 'pre_argument': '',
         "user_id": user_id},
        {'argument_key': 'client_ip', 'argument_description': '客户端ip', 'type': 'string', 'pre_argument': '',
         "user_id": user_id},
        {'argument_key': 'time', 'argument_description': '时间', 'type': 'string', 'pre_argument': '',
         "user_id": user_id},
